    ...
    public partial class Form1 : Form
    {
      ...
      #region
                       ...
                       
                        {
                            ...
                            string query = " INSERT INTO statistic( Part_number , Serial_number , linha , Painel_Placa , Data_Hora , Placa_Rpass , Placa_Repair , PAD , Placa_pass) VALUES ('" + part_number +  "','" + serial_number + "','" + linha_spi + "' , '" + painel_placa + "' , '" + hora_criacao + "' , '" + Placa_Rpass + "' , '" + Placa_Repair + "' , '" + numero_pad + "' , '" + placa_pass +  "');";  //Grava as infromçãos do log no BD
